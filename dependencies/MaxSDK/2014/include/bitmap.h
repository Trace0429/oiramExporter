...
/*! \sa  Class Bitmap, <a href="ms-its:3dsmaxsdk.chm::/bitmaps_root.html">Working with Bitmaps</a>, \ref bitmapErrorCodes.\n\n
...
//@{
		...
		/*! 
		    If BMM_CUSTOM_FILEGAMMA is set prior to loading a file (caling BitmapManager::Load()), the BitmapManager will attempt to load a file
...
/*! \sa  Class Bitmap, Class BitmapStorage, Class BitmapInfo, Class BitmapIOMetaData, <a href="ms-its:3dsmaxsdk.chm::/bitmaps_root.html">Working with
Bitmaps</a>.\n\n
...
(retreivable via <b>BitmapIO::GetInterface(BITMAPIOMETADATA_INTERFACE_ID)</b>).
...
true if that BitmapIO would like to (by default) load and save data linearily 
    ...
    \endcode      
	  ...
	  */
	  ...
	  BMMExport BMMRES         OpenOutput                  ( BitmapInfo *bi );
		...
		\param BitmapInfo* bi - Contains the name of the file or device to write to.
		\param DWORD frame - Specifies the frame number to write. If this is a single image, allow
...
#pragma warning( disable : 4481 )
	...
	virtual BOOL BrowseBitmapFilesInput(BitmapInfo* info, HWND hWnd, MCHAR* title, BOOL view) MAX_SEALED { return 
		BrowseBitmapFilesInput(info, hWnd, const_cast<const MCHAR*>(title), view); }
#pragma warning( pop )
	};

class BitmapFileOutputDialog: public MaxHeapOperators {
	public:
	virtual BOOL BrowseBitmapFilesOutput(BitmapInfo* info, HWND hWnd, const MCHAR* title) = 0;
#pragma warning( push )
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual BOOL BrowseBitmapFilesOutput(BitmapInfo* info, HWND hWnd, MCHAR* title) MAX_SEALED { return 
		BrowseBitmapFilesOutput(info, hWnd, const_cast<const MCHAR*>(title)); }
#pragma warning( pop )
	};
...
#pragma warning( disable : 4481 )
	  //! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	  virtual BOOL SelectFileOutput ( BitmapInfo *bi, HWND hWnd, MCHAR *title, ULONG *pflags) MAX_SEALED { return 
		  SelectFileOutput(bi, hWnd, const_cast<const MCHAR*>(title), pflags); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	  //! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	  virtual BOOL SelectFileInput ( BitmapInfo *bi, HWND hWnd, MCHAR *title) MAX_SEALED { return 
		  SelectFileInput(bi, hWnd, const_cast<const MCHAR*>(title)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	  //! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	  virtual BOOL SelectFileInputEx ( BitmapInfo *bi, HWND hWnd, MCHAR *title, BOOL viewonly) MAX_SEALED { return 
		  SelectFileInputEx(bi, hWnd, const_cast<const MCHAR*>(title), viewonly); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual void		ShowConfigDialog( Tab<MCHAR*>* bitmapFilenames ) MAX_SEALED { ShowConfigDialog((Tab<const MCHAR*>*) bitmapFilenames); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual void		ShowPrecacheDialog( Tab<MCHAR*>* bitmapFilenames ) MAX_SEALED { ShowPrecacheDialog((Tab<const MCHAR*>*) bitmapFilenames); }
#pragma warning( pop )
...
/*! The three out parameters are allowed to be NULL. For non-NULL parameters, it is also assumed 
	...
	\param[out] directory - A string containing the file extension portion of the file path */
...
\par
If this interface is exposed, it can make a decision wether that BitmapIO implementation
would preffer to save or load data linearily. It is called by the code in 
...
class BitmapIOMetaData : public BaseInterface {
	public:
		//! \brief Does this BitmapIO preffer linear data or not?
		//! \param save is true if we are saving, false for loading.
		//! \return <i>true</i> if we preffer linear storage, <i>false</i> if we want to use the the default - generally sRGB - gamma.
		/*! 
			\par Usage:
